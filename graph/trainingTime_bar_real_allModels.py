...
rects1 = ax.bar(ind[0], cflmd[1]*1.25, width, color=[(1,0.7,0)],edgecolor='black',label="CFLM")

bfl = vals_g['bfl'].tolist()
rects2 = ax.bar(ind[0]+width, bfl[1]*1.25, width, color='pink',edgecolor='black',label="FedCPF")

afl = vals_g['afl'].tolist()
ax.bar(ind[0]+width*2, afl[1]*1.25, width, color = 'cyan', edgecolor='black', label="LDF")

cfl = vals_g['cfl'].tolist()
rects3 = ax.bar(ind[0]+width*3, cfl[1]*1.25, width, color='darkgrey',edgecolor='black',label="CEFL")
...
rects1 = ax.bar(ind[0]+width*4, lgc[1]*1.25, width, color='yellow', edgecolor='black', label="LGC")
...
rects3 = ax.bar(ind[0]+width*5, cflmd_m[1]*1.25, width, color='tomato',edgecolor='black',label="CFLM/DS")

cflmd_cs = vals_g['cflmd_cs'].tolist()
rects4 = ax.bar(ind[0]+width*6, cflmd_cs[1]*1.25, width, color='deepskyblue',edgecolor='black',label="CFLM/US")

cflmd_fd = vals_g['cflmd_fd'].tolist()
rects1 = ax.bar(ind[0]+width*7, cflmd_fd[1]*1.25, width, color='lime',edgecolor='black',label="CFLM/FD")

cflmd_de = vals_g['cflmd_de'].tolist()
rects2 = ax.bar(ind[0]+width*8, cflmd_de[1]*1.25, width,color = 'beige', edgecolor = 'black', label = "CFLM/DE")



cflmd = vals_v['cflmd'].tolist()
rects1 = ax.bar(ind[1], cflmd[1], width, color=[(1,0.7,0)],edgecolor='black')

bfl = vals_v['bfl'].tolist()
rects2 = ax.bar(ind[1]+width, bfl[1], width, color='pink',edgecolor='black')

afl = vals_v['afl'].tolist()
ax.bar(ind[1]+width*2, afl[1], width, color = 'cyan', edgecolor='black')

cfl = vals_v['cfl'].tolist()
rects3 = ax.bar(ind[1]+width*3, cfl[1], width, color='darkgrey',edgecolor='black')

# new_fl = vals['FL'].tolist()
# rects4 = ax.bar(ind[0]+width*3, new_fl[0], width, color='purple', edgecolor='black',hatch='/o', label="BFL1")

lgc = vals_v['lgc'].tolist()
rects1 = ax.bar(ind[1]+width*4, lgc[1], width, color='yellow', edgecolor='black')

# cflmd_wo_group = vals['cflmd_wo_group'].tolist()
# rects2 = ax.bar(ind[0]+width*5, cflmd_wo_group[0], width, color='crimson',edgecolor='black',hatch="|*",label="TrustMe/H")

cflmd_m = vals_v['cflmd_m'].tolist()
rects3 = ax.bar(ind[1]+width*5, cflmd_m[1], width, color='tomato',edgecolor='black')

cflmd_cs = vals_v['cflmd_cs'].tolist()
rects4 = ax.bar(ind[1]+width*6, cflmd_cs[1], width, color='deepskyblue',edgecolor='black')

cflmd_fd = vals_v['cflmd_fd'].tolist()
rects1 = ax.bar(ind[1]+width*7, cflmd_fd[1], width, color='lime',edgecolor='black')

cflmd_de = vals_v['cflmd_de'].tolist()
rects2 = ax.bar(ind[1]+width*8, cflmd_de[1], width,color = 'beige', edgecolor = 'black')



cflmd = vals_l['cflmd'].tolist()
rects1 = ax.bar(ind[2], cflmd[1]*0.75, width, color=[(1,0.7,0)],edgecolor='black')

bfl = vals_l['bfl'].tolist()
rects2 = ax.bar(ind[2]+width, bfl[1]*0.75, width, color='pink',edgecolor='black')

afl = vals_l['afl'].tolist()
ax.bar(ind[2]+width*2, afl[1]*0.75, width, color = 'cyan', edgecolor='black')

cfl = vals_l['cfl'].tolist()
rects3 = ax.bar(ind[2]+width*3, cfl[1]*0.75, width, color='darkgrey',edgecolor='black')

# new_fl = vals['FL'].tolist()
# rects4 = ax.bar(ind[0]+width*3, new_fl[0], width, color='purple', edgecolor='black',hatch='/o', label="BFL1")

lgc = vals_l['lgc'].tolist()
rects1 = ax.bar(ind[2]+width*4, lgc[1]*0.75, width, color='yellow', edgecolor='black')

# cflmd_wo_group = vals['cflmd_wo_group'].tolist()
# rects2 = ax.bar(ind[0]+width*5, cflmd_wo_group[0], width, color='crimson',edgecolor='black',hatch="|*",label="TrustMe/H")

cflmd_m = vals_l['cflmd_m'].tolist()
rects3 = ax.bar(ind[2]+width*5, cflmd_m[1]*0.75, width, color='tomato',edgecolor='black')

cflmd_cs = vals_l['cflmd_cs'].tolist()
rects4 = ax.bar(ind[2]+width*6, cflmd_cs[1]*0.75, width, color='deepskyblue',edgecolor='black')

cflmd_fd = vals_l['cflmd_fd'].tolist()
rects1 = ax.bar(ind[2]+width*7, cflmd_fd[1]*0.75, width, color='lime',edgecolor='black')

cflmd_de = vals_l['cflmd_de'].tolist()
rects2 = ax.bar(ind[2]+width*8, cflmd_de[1]*0.75, width,color = 'beige', edgecolor = 'black')
