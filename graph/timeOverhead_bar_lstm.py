...
vals_m = pd.read_csv('m_bar_lstm.csv')
vals_cs = pd.read_csv('cs_bar_lstm.csv')
vals_fd = pd.read_csv('fd_bar_lstm.csv')
vals_de = pd.read_csv('de_bar_lstm.csv')
...
cflmd_cs = np.array(vals_cs['cflmd'].tolist())*0.75
cflmd_fd = np.array(vals_fd['cflmd'].tolist())*0.75
cflmd_de = np.array(vals_de['cflmd'].tolist())*0.75
...
bfl_cs = np.array(vals_cs['bfl'].tolist())*0.75
bfl_fd = np.array(vals_fd['bfl'].tolist())*0.75
bfl_de = np.array(vals_de['bfl'].tolist())*0.75
...
afl_cs = np.array(vals_cs['afl'].tolist())*0.75
afl_fd = (np.array(vals_fd['afl'].tolist()))*0.75
afl_de = (np.array(vals_de['afl'].tolist()))*0.75
...
cfl_cs = np.array(vals_cs['cfl'].tolist())*0.75
cfl_fd = (np.array(vals_fd['cfl'].tolist()))*0.75
cfl_de = (np.array(vals_de['cfl'].tolist()))*0.75
...
lgc_cs = np.array(vals_cs['lgc'].tolist())*0.75
lgc_fd = (np.array(vals_fd['lgc'].tolist()))*0.75
lgc_de = (np.array(vals_de['lgc'].tolist()))*0.75
...
cflmd_m_cs = np.array(vals_cs['cflmd_m'].tolist())*0.75
cflmd_m_fd = np.array(vals_fd['cflmd_m'].tolist())*0.75#np.array(vals_fd['cflmd_m'].tolist())/100+0.05
cflmd_m_de = np.array(vals_de['cflmd_m'].tolist())*0.75
...
cflmd_cs_cs = np.array(vals_cs['cflmd_cs'].tolist())*0.75
cflmd_cs_fd = np.array(vals_fd['cflmd_cs'].tolist())*0.75
cflmd_cs_de = np.array(vals_de['cflmd_cs'].tolist())*0.75
...
cflmd_fd_cs = np.array(vals_cs['cflmd_fd'].tolist())*0.75
cflmd_fd_fd = np.array(vals_fd['cflmd_fd'].tolist())*0.75
cflmd_fd_de = np.array(vals_de['cflmd_fd'].tolist())*0.75
...
cflmd_de_cs = np.array(vals_cs['cflmd_de'].tolist())*0.75
cflmd_de_fd = np.array(vals_fd['cflmd_de'].tolist())*0.75
cflmd_de_de = np.array(vals_de['cflmd_de'].tolist())*0.75
