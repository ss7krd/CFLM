...
vals_m = pd.read_csv('m_bar_real_allModels.csv')
vals_cs = pd.read_csv('cs_bar_real_allModels.csv')
vals_fd = pd.read_csv('fd_bar_real_allModels.csv')
vals_de = pd.read_csv('de_bar_real_allModels.csv')
...
cflmd_cs = np.array(vals_cs['cflmd'].tolist())
cflmd_fd = np.array(vals_fd['cflmd'].tolist())
cflmd_de = np.array(vals_de['cflmd'].tolist())
...
bfl_cs = np.array(vals_cs['bfl'].tolist())
bfl_fd = np.array(vals_fd['bfl'].tolist())
bfl_de = np.array(vals_de['bfl'].tolist())
...
afl_cs = np.array(vals_cs['afl'].tolist())
afl_fd = (np.array(vals_fd['afl'].tolist()))
afl_de = (np.array(vals_de['afl'].tolist()))
...
cfl_cs = np.array(vals_cs['cfl'].tolist())
cfl_fd = (np.array(vals_fd['cfl'].tolist()))
cfl_de = (np.array(vals_de['cfl'].tolist()))
...
lgc_cs = np.array(vals_cs['lgc'].tolist())
lgc_fd = (np.array(vals_fd['lgc'].tolist()))
lgc_de = (np.array(vals_de['lgc'].tolist()))
...
cflmd_m_cs = np.array(vals_cs['cflmd_m'].tolist())
cflmd_m_fd = np.array(vals_fd['cflmd_m'].tolist())#np.array(vals_fd['cflmd_m'].tolist())/100+0.05
cflmd_m_de = np.array(vals_de['cflmd_m'].tolist())
...
cflmd_cs_cs = np.array(vals_cs['cflmd_cs'].tolist())
cflmd_cs_fd = np.array(vals_fd['cflmd_cs'].tolist())
cflmd_cs_de = np.array(vals_de['cflmd_cs'].tolist())
...
cflmd_fd_cs = np.array(vals_cs['cflmd_fd'].tolist())
cflmd_fd_fd = np.array(vals_fd['cflmd_fd'].tolist())
cflmd_fd_de = np.array(vals_de['cflmd_fd'].tolist())
...
cflmd_de_cs = np.array(vals_cs['cflmd_de'].tolist())
cflmd_de_fd = np.array(vals_fd['cflmd_de'].tolist())
cflmd_de_de = np.array(vals_de['cflmd_de'].tolist())
...
xvalues = ['GoogleNet', 'VGG-16', 'LSTM']
# plt.xticks(xvalues)
# plt.xticks(xvalues)
ax.set_xticklabels(xvalues, fontsize=40)
