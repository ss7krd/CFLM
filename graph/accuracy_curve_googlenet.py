...
vals = pd.read_csv('accuracy_curve_googlenet.csv')
# vals_eachComp = pd.read_csv('accuracy_data_each_comp.csv')

our_system = np.array(vals['cflmd'].tolist())+0.1
...
bfl = np.array(vals['bfl'].tolist())+0.1
...
cflmd_m = np.array(vals['cflmd_m'].tolist())+0.1
