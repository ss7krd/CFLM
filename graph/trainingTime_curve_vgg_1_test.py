...
vals = pd.read_csv('trainingTime_curve_vgg.csv')
# vals_eachComp = pd.read_csv('accuracy_data_each_comp.csv')

our_system = vals['cflmd'].tolist()
...
ax.errorbar(stepX,our_system,yerr=[[1,1.2,1,1,1.2,1],[1,1.2,1,1,1.2,1]],capsize=15,c='red',mew=4,marker="+",markersize=26,ls='-',label="CFLMD",fillstyle='full', linewidth = 4)

bfl = vals['bfl'].tolist()
ax.errorbar(stepX,bfl,c='lime',yerr=[[1,1.2,1,1,1.2,1],[1,1.2,1,1,1.2,1]],capsize=15,marker="*",markersize=26,ls='-',label="FedCPF",fillstyle='full', linewidth = 4)
...
ax.plot(stepX,cflmd_m,c='green',marker="h",markersize=26,ls='-',label="CFLMD/M",fillstyle='full', linewidth = 4)
...
ax.plot(stepX,cflmd_cs,c='black',marker="D",markersize=15,ls='-',label="CFLMD/CS",fillstyle='full', linewidth = 4)

cflmd_fd = vals['cflmd_fd'].tolist()
ax.plot(stepX,cflmd_fd,c='pink',marker="<",markersize=26,ls='-',label="CFLMD/FD",fillstyle='full', linewidth = 4)

cflmd_de = vals['cflmd_de'].tolist()
ax.plot(stepX, cflmd_de, c = 'gold', marker = '>', markersize = 26, ls = '-', label = "CFLMD/DE", fillstyle = 'full', linewidth = 4)
